...
const module = {
  ...
  description: "First Module in NodeJS",
  course: "CS5610",
};
...
const Lab5 = (app) => {
  ...
  app.get("/a5/assignment/Complete/:isCompleted", (req, res) => {
    const { isCompleted } = req.params;
    assignment.complete = isCompleted === "true";
    res.json(assignment);
  });
